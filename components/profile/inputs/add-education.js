...
const AddEducation = (props) => {
    ...
    const onSubmit = async (data) => {
        ...
        if(user){
            ...
            db.collection('users').doc(user.uid).collection('education').doc().set(data)
            .then(() => {
                console.log("Success")
    ...
    return (
      ...
      <div className="modal-container centre-translate">
          <div className="modal"> 
              <h2 className="modal-heading">Add Education</h2>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <button type="submit" className="modal-button">Add Education</button>
