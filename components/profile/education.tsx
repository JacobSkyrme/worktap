...
import {faGraduationCap, faPen, faTrash, faPlusCircle} from "@fortawesome/free-solid-svg-icons"
...
//TODO Swap user prop for context provider
                ...
                <div className="wt-container profile-container">
                    <div className="profile-icon-container">
                        <div className="profile-section-icon" >
                            <FontAwesomeIcon className="fa-3x centre-translate profile-section-icon" icon={faGraduationCap}/>
                        </div>
                    </div>
